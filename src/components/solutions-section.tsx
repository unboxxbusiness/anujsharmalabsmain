...
export function SolutionsSection() {
  ...
  return (
    <section aria-labelledby="solutions-heading" className="py-16 md:py-32">
      <div className="max-w-5xl mx-auto px-6 mb-12 text-center">
        <Typography variant="h2" as="h2" id="solutions-heading">
    ...
    >
      ...
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        ...
        <Typography
          ...
          className="group-hover/feature:translate-x-2 transition duration-200 inline-block text-neutral-800 dark:text-neutral-100 !text-lg !p-0 !border-none"
        >
          {title}
        </Typography>
      </div>
