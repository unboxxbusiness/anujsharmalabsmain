                    ...
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-20">
                        <div className="lg:flex lg:items-center lg:gap-12">
                            <div className="relative z-10 mx-auto max-w-xl text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                ...
                                <h1 className="mt-10 text-balance text-4xl font-bold md:text-5xl xl:text-5xl">Automate Marketing. Save Time. Scale with AI.</h1>
                                ...
                                <div>
                                    <p className="font-semibold mt-8">Enter your email to get my free AI Automation Toolkit</p>
                                    <form
                                        action=""
                                        className="mx-auto my-6 max-w-sm lg:ml-0 lg:mr-auto">
                                        <div className="bg-background has-[input:focus]:ring-muted relative grid grid-cols-[1fr_auto] items-center rounded-[1rem] border pr-1 shadow shadow-zinc-950/5 has-[input:focus]:ring-2">
                                            ...
                                            <div className="md:pr-1.5 lg:pr-0">
                                                <Button
                                                    aria-label="submit"
                                                >
                                                    <span className="hidden md:block">Get the Toolkit</span>
                                                    <SendHorizonal
                        ...
                        <div className="absolute inset-0 -mx-4 rounded-3xl p-3 lg:col-span-3">
                            ...
                            <div className="relative">
                                ...
                                <Image
                                    ...
                                    src="https://picsum.photos/seed/b/1200/800"
                                    alt="app illustration"
                                    width={2796}
                                    height={2008}
                                />
